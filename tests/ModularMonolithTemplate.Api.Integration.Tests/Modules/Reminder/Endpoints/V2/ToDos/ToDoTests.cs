using ModularMonolithTemplate.Api.Modules.Reminder.Endpoints.V2.Todos;

namespace ModularMonolithTemplate.Api.Integration.Tests.Modules.Reminder.Endpoints.V2.ToDos;
